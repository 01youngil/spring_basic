...
// Component 어노테이선을 통해 별도의 객체를 생성할 필요가 없는, 싱글톤 객체를 생성
// Controller 어노테이션을 통해 쉽게 사용자의 http 요청을 처리하고, http응답을 줄수 있음
@Controller
// 클래스차원의 url매핑시에는 RequestMapping사용
@RequestMapping("/hello")
public class HellloController {
//    case1. 서버가 사용자에게 단순 String 데이터 return(get)요청 - @ResponseBody 있을때
//    case2. 서버가 사용자에게 화면을 return(get요청) - ResponseBody 없을때
    @GetMapping("")
//    @ResponseBody
...
//    case1. form데이터형식의 post요청 처리(텍스트만 있는 application/x-www~)
...
//    java에서 파일을 처리하는 클래스 : MultipartFile
    public String formPost2(@ModelAttribute Hello hello, @RequestParam(value="photo") MultipartFile photo){
        System.out.println(hello);
